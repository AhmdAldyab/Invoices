...
@section('content')
    <!-- row -->
    @php
    $invoices_count = \App\invoices::count();
    @endphp
                    ...
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                ...
                                <p class="mb-0 tx-12 text-white op-7">عدد الفواتير الغير
                                    مدفوعة&nbsp;{{ \App\invoices::where('Value_Status', 2)->count() }}</p>
                            </div>
                            <span class="float-right my-auto mr-auto">
                        ...
                        <div class="d-flex">
                            <div class="">
                                ...
                                <p class="mb-0 tx-12 text-white op-7">عدد الفواتير
                                    مدفوعة&nbsp;{{ \App\invoices::where('Value_Status', 1)->count() }}</p>
                            </div>
                            <span class="float-right my-auto mr-auto">
                                <i class="fas fa-arrow-circle-up text-white"></i>
                                <span class="text-white op-7">
                    ...
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                ...
                                <p class="mb-0 tx-12 text-white op-7">عدد الفواتير مدفوعة
                                    جزئيا&nbsp;{{ \App\invoices::where('Value_Status', 3)->count() }}</p>
                            </div>
                            <span class="float-right my-auto mr-auto">
                                <i class="fas fa-arrow-circle-down text-white"></i>
                                <span class="text-white op-7">
