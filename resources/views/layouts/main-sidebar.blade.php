...
<aside class="app-sidebar sidebar-scroll">
    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            <li class="side-item side-item-category">برنامج تسديد الفواتير</li>
            <li class="slide">
            ...
            @can('الفواتير')
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        <li><a class="slide-item" href="{{ url('/' . ($page = 'Invoice_Partail')) }}">الفواتير
                                المدفوعة
                                جزئيا</a></li>
                        @endcan
                        <li><a class="slide-item" href="{{ url('/' . ($page = 'invoice_Archive')) }}">الفواتير
                                المؤرشفة</a></li>
                    </ul>
                </li>
            @endcan
